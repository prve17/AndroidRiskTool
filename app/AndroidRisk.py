...
class AndroidRisk(object):
    ...
    def get_training_apks(self):
        """
        Get the list of apks used to train AndroidRisk.
    ...
    def train_classifiers(self):
        """
        Train the classifiers used in AndroidRisk.
    ...
    def rescale_risk(self, original_risk: float):
        ...
        The new risk value will be in a range between 0 and 10.

        :param original_risk: The original risk value between 0 and 1.
        :return: The rescaled risk value between 0 and 10.
        """

        _risk_value = original_risk * 10

        # noinspection PyUnresolvedReferences
        return (5 / numpy.log(11)) * (
            numpy.log(_risk_value + 1) - numpy.log(11 - _risk_value)
        ) + 5
    
    def calculate_risk(self, feature_vector: dict):
        """
        Calculate the AndroidRisk risk for a specified feature vector.
    ...
    def performance_analysis(self):
        ...
        in order to include only the best ones in the final version of AndroidRisk
        .
        ...
        # only the best ones for AndroidRisk
        # .
        _all_models = (
    ...
    def calculate_set_accuracy(self):
        """
        Calculate the accuracy of the training set used for AndroidRisk
        .
        ...
        for train_index, test_index in _k_fold.split(_apks[_cat], _targets):
            ...
            # Train the AndroidRisk
            #  classifiers for the current fold.
            for m in tqdm(
                self.MODELS,
                dynamic_ncols=True,
                desc="Training classifiers",
